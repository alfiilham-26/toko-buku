                ...
                <div class="col-lg-8">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Laporan Semua Buku</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-4">
                    <div class="title-action">
                        <a href="/laporan-data-buku/cetak" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Laporan </a>
                    </div>
                </div>
            </div>
