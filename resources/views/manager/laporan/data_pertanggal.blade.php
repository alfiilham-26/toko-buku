...
<div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-8">
                    <div class="title-action">
                        <a href="/manager/penjualan-pertanggal/cetak" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Laporan </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                    ...
                    <form action="{{ url('/manager/penjualan-pertanggal/cari') }}" method="POST">
                            @csrf
                            <div class="form-body">
