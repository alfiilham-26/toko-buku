...
@section('title','Cetak Data Semua Penjualan')

@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-8">
                    <h2>Cetak Data Semua Penjualan</h2>
                    <ol class="breadcrumb">
                ...
                <div class="col-lg-4">
                    <div class="title-action">
                        <a href="/manager/cetak/semua-penjualan" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Data </a>
                    </div>
                </div>
            </div>
                    ...
                    @foreach($tmp as $tmp)
                        ...
                        <h1>{{$tmp->nama_perusahaan}}</h1>
                            <address>
                                ...
                                {{$tmp->email}}<br>
                                {{$tmp->web}}
                                <h2 class="text-center">Struk Semua Penjualan</h2>
                            </address>
                        </div>
                     @endforeach
